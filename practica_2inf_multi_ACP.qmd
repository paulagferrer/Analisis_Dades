...
```{r}
# cargamos datos
datosVH <- read.table(file = "ANIMALS-matrixVH.txt", header = TRUE, sep = " ")
datosSP <- read.table(file = "ANIMALS-matrixSP.txt", header = TRUE, sep = " ")
datosPM <- read.table(file = "ANIMALS-matrixPM.txt", header = TRUE, sep = " ")
