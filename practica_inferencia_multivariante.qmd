...
Siendo $\hat{\beta}$ i $\hat{\sigma}^2$ los estimadores de máxima verosimilitud. Notamos que necesitamos que $X^t X$ sea invertible o, equivalentemente, que el rango de $X$ sea máximo.
Lo metemos en R:
