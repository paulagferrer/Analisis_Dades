...
contribuciones a las medias de manera que la media de la variable
compuesta $Y$ se puede ver como suma ponderada de las medias:
$\bar{Y} = a'\bar{X}$, donde $a' = a$.

De esta manera que las contribuciones numéricas quedan:
...
mayor, ya que hemos priorizado las ventas.
