...
\<\<\<\<\<\<\< HEAD Los conjuntos de igual distancia $D^2=c$, son
elipses o elipsoides. La distancia de Mahalanobis define niveles de
densidad constante en la normal multivariente. Un punto puede parecer
normal univariante pero atipico al considerar la combinacion conjunta de
variables
