...
$\Sigma_{ij} = Cov(X_i,X_j)=A$ son els elements fora de sa diagonal.
Llavors,
=======
$\Sigma_{ij} = Cov(X_i,X_j)=A$ son els elements fora de sa
diagonal. Llavors,
>>>>>>> 00c3f8a167f1bd3e502dd4809c1ac2fc2cefa447
...
<<<<<<< HEAD
Los conjuntos de igual distancia $D^2=c$, son elipses o elipsoides. La
distancia de Mahalanobis define niveles de densidad constante en la
normal multivariente. Un punto puede parecer normal univariante pero
atipico al considerar la combinacion conjunta de variables
=======
Los conjuntos de igual distancia $D^2=c$, son elipses o
...
pinguinos_complete %>% filter(atipico == TRUE)
...
<<<<<<< HEAD
Observamos que la distancia de Mahalanobis devuelve datos atípicos
multivariantes però en los boxplots no se detectan datos atípicos
univariantes.
=======
Observamos que la distancia de Mahalanobis devuelve datos atípicos multivariantes però en los boxplots no se detectan datos atípicos univariantes.
>>>>>>> 00c3f8a167f1bd3e502dd4809c1ac2fc2cefa447
...
<<<<<<< HEAD
mardia_test  <- MVN::mvn(data = pinguinos, mvn_test = "mardia")
hz_test      <- MVN::mvn(data = pinguinos, mvn_test = "hz")
royston_test <- MVN::mvn(data = pinguinos, mvn_test = "royston")
=======
mardia_test  <- mvn(data = pinguinos, mvn_test = "mardia")
hz_test      <- mvn(data = pinguinos, mvn_test = "hz")
royston_test <- mvn(data = pinguinos, mvn_test = "royston")
>>>>>>> 00c3f8a167f1bd3e502dd4809c1ac2fc2cefa447
...
Si por ejemplo elegimos (X1,X2) = (long pico, long aleta)
